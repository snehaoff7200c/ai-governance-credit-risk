...
**1. Accuracy hides more than it reveals.** The model scores 80.6% accuracy but only **27% recall** — meaning it misses roughly 3 out of 4 people who actually default. Full details in the model card.
